...
def calculate_classification_metrics_multitarget(debugger, total_logits, total_true, number_of_classes, threshold):
    results = []
    for logits, true_values, classes_count in zip(total_logits, total_true, number_of_classes):
        results.append(calculate_classification_metrics_singletarget(debugger, logits, true_values, classes_count, threshold))
    return results
